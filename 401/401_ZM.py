...
plt.title(f'Intensität in Abhängigkeit des Winkels ohne Magnetfeld', fontsize = 14)
plt.grid()
...
plt.title(f'Abstände der Maxima', fontsize = 14)
plt.grid()
plt.ylabel('Abstand $\\Delta \\alpha$ / °', fontsize = 12)
plt.xlabel('Winkel $\\alpha$ / °', fontsize = 12)
